...
function Header() {
  ...
  <h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <br></br> <span className='text-blue-600'>image</span>, in seconds.</h1>
